    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['download_password'])) {
                if ($_POST['download_password'] === $data['passwords']['main']) {
...
<body>
    <div class="container">
        ...
        <div class="info-box">
            ...
            <div class="code">https://domain.com/confnew.php?create&count=تعداد</div>
            <p><strong>مثال:</strong></p>
            <div class="code">https://domain.com/confnew.php?create&count=5</div>
        </div>
        ...
        <div class="info-box">
            ...
            <p>✅ رمز یک بار مصرف برای دانلود لینک‌ها</p>
            <p>✅ انقضای خودکار توکن دانلود بعد از ۱۲ ساعت</p>
            <p>✅ پنل مدیریت کامل</p>
        ...
        <div class="btn-section">
            <a href="?create&count=1" class="btn btn-main">📥 ساخت کانفیگ</a>
